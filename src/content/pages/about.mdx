...
The project is still in development. You can follow the progress on [Twitter](https://twitter.com/blefnk).
...
- [Taxonomy](https://tx.shadcn.com) - For stripe subscription implementation
- [shadcn/ui](https://ui.shadcn.com) - For the awesome reusable components library

## About the author

Hi, I'm [blefnk](https://twitter.com/blefnk). Self-taught web developer building websites with AI and [Next.js](https://nextjs.org/). My socials are below.
